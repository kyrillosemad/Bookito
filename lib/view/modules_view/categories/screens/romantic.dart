...
class _RomanticState extends State<Romantic> {
  ...
  void initState() {
    super.initState();
    context.read<BookShowBloc>().add(FetchRomanticBooks(search.text));
  }
            ...
            children: [
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const TopTitle(title: "Romantic Books"),
                      SizedBox(
                        height: 2.h,
                      ),
                      Search(
                        onchanged: (value) {
                          context
                              .read<BookShowBloc>()
                              .add(FetchRomanticBooks(value.toString()));
                        },
                        search: search,
                      ),
                      SizedBox(
                      ...
                      Text(
                        "You can find here all your Romantic books",
                        style: TextStyle(
              ...
              BlocBuilder<BookShowBloc, BookShowState>(
                builder: (context, state) {
                  ...
                  } else if (state is ShowRomanticBooks) {
                    return BookItem(state: state.romanticBooks);
