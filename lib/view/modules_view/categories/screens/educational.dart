...
class _EducationalState extends State<Educational> {
  ...
  void initState() {
    super.initState();
    context.read<BookShowBloc>().add(FetchEducationalBooks(search.text));
  }
            ...
            children: [
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const TopTitle(title: "Educational Books"),
                      SizedBox(
                        height: 2.h,
                      ),
                  Search(
                        onchanged: (value) {
                          context.read<BookShowBloc>().add(FetchEducationalBooks(value.toString()));
                        },
                        search: search,
                      ),
                      SizedBox(
                      ...
                      Text(
                        "You can find here all your Educational books",
                        style: TextStyle(
              ...
              BlocBuilder<BookShowBloc, BookShowState>(
                builder: (context, state) {
                  ...
                  } else if (state is ShowEducationalBooks) {
                    return BookItem(state: state.educationalBooks);
