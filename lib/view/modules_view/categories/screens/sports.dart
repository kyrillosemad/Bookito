...
class _SportsState extends State<Sports> {
  ...
  void initState() {
    super.initState();
    context.read<BookShowBloc>().add(FetchSportsBooks(search.text));
  }
            ...
            children: [
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      const TopTitle(title: "Sports Books"),
                      SizedBox(
                        height: 2.h,
                      ),
                      Search(
                        onchanged: (value) {
                          context
                              .read<BookShowBloc>()
                              .add(FetchSportsBooks(value.toString()));
                        },
                        search: search,
                      ),
                      SizedBox(
                      ...
                      Text(
                        "You can find here all your Sports books",
                        style: TextStyle(
              ...
              BlocBuilder<BookShowBloc, BookShowState>(
                builder: (context, state) {
                  ...
                  } else if (state is ShowSportsBooks) {
                    return BookItem(state: state.sportsBooks);
